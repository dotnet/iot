...
namespace Iot.Device.Fsr408.Samples
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (fsr408)
            {
                //Fsr produces analog signal, we can read this with 2 way, below commented section shows example read with capacitor 
                /*
                ...
                */
                ...
                fsr408.AdcConverter = new Mcp3008(18, 23, 24, 25);
