...
namespace Iot.Device.Imu
{
    ...
    internal enum UserControls
    {
        ...
        // NOTE:  This bit should only be set when the I2C master is non-responsive.  If this bit is set during an active I2C master transaction,
        // the I2C Replica will hang, which will require the host to reset the Replica.
        ...
        // 1 – Reset I2C Replica module and put the serial interface in SPI mode only.  This bit auto clears after one clock cycle.
