...
namespace Iot.Device.StUsb4500.Objects
{
    ...
    public class VariableSupplyObject : PowerDeliveryObject
    {
        ...
        public override double Power => 0; // not clearly defined for variable source
        ...
        public override string ToString() => $"{nameof(VariableSupplyObject)}: {MinimalVoltage:0.##}V - {MaximalVoltage:0.##}V @ {OperationalCurrent:0.##}A";
    }
}
