...
namespace Iot.Device.Card.CreditCardProcessing
{
    ...
    public class CreditCard
    {
        ...
        /// usually 0x00 especailly NFC ones. While Smart Card readers usually do not
        /// </summary>
        ...
        /// </summary>
        /// <param name="unpredictableNumber">the unpredictable number to be generated byt the card, it should be 8 bytes</param>
        /// <returns>The error status</returns>
