...
namespace Iot.Device.Card.CreditCardProcessing
{
    ...
    /// </summary>
    [Flags]
    public enum TerminalTransactionQualifier
    {
        // byte 1 byte 2 byte 3 byte 4
        // byte 1
        // bit 8: 1 = Mag-stripe mode supported 
        MagStripeSupported = 0b1000_0000_0000_0000_0000_0000,
        // bit 7: RFU (0)         
        // bit 6: 1 = EMV mode supported 
        EmvModeSuypported = 0b0010_0000_0000_0000_0000_0000,
        // bit 5: 1 = EMV contact chip supported 
        EmvContachChipSupported = 0b0001_0000_0000_0000_0000_0000,
        // bit 4: 1 = Offline-only reader
        OfflineOnlyReader = 0b0000_1000_0000_0000_0000_0000,
        // bit 3: 1 = Online PIN supported
        OnlinePinSupported = 0b0000_0100_0000_0000_0000_0000,
        // bit 2: 1 = Signature supported 
        SignatureSupported = 0b0000_0010_0000_0000_0000_0000,
        // bit 1: 1 = Offline Data Authentication for Online Authorizations supported. 
        OfflineDataAuthentication = 0b0000_0001_0000_0000_0000_0000,
        ...
        OnlineCryptogramRequired = 0b0000_0000_1000_0000_0000_0000,
        ...
        CvmRequired = 0b0000_0000_0100_0000_0000_0000,
        // bit 6: 1 = (Contact Chip) Offline PIN supported 
        ConstactChipOfflinePinSupported = 0b0000_0000_0010_0000_0000_0000,
        // bits 5-1: RFU (0,0,0,0,0)
        // Byte 3 
        // bit 8: 1 = Issuer Update Processing supported 
        IssuerUpdateProcessingSupported = 0b0000_0000_0000_0000_1000_0000,
        // bit 7: 1 = Consumer Device CVM supported 
        ConsumerDeviceCvmSupported = 0b0000_0000_0000_0000_0100_0000,
