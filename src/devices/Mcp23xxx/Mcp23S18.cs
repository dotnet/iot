...
namespace Iot.Device.Mcp23xxx
{
    ...
    public class Mcp23s18 : Mcp23x1x
    {
        ...
        public Mcp23s18(SpiDevice spiDevice, int reset = -1, int interruptA = -1, int interruptB = -1, GpioController? controller = null, bool shouldDispose = true)
            : base(new SpiAdapter(spiDevice, 0x20), reset, interruptA, interruptB, controller, shouldDispose)
        {
        }
    }
}
