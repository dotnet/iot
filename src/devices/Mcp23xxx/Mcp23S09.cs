...
namespace Iot.Device.Mcp23xxx
{
    ...
    public class Mcp23s09 : Mcp23x0x
    {
        ...
        public Mcp23s09(SpiDevice spiDevice, int reset = -1, int interrupt = -1, GpioController? controller = null, bool shouldDispose = true)
            : base(new SpiAdapter(spiDevice, 0x20), reset, interrupt, controller, shouldDispose)
        {
        }
    }
}
