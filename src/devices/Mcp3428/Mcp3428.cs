...
namespace Iot.Device.Mcp3428 
{
    public class Mcp3428 : Mcp342x 
    {
        ...
        /// <inheritdoc />
        public Mcp3428(I2cDevice i2CDevice, ModeEnum mode = ModeEnum.Continuous, ResolutionEnum resolution = ResolutionEnum.Bit12, GainEnum pgaGain = GainEnum.X1) : this(i2CDevice) 
        {
