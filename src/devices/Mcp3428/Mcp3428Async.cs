...
namespace Iot.Device.Mcp3428
{
    ...
    /// <autogeneratedoc />
    public class Mcp3428Async : Mcp3428
    {
        ...
        /// <inheritdoc />
        public Mcp3428Async(I2cDevice i2CDevice) : base(i2CDevice,4)
        {
        }

        /// <inheritdoc />
        public Mcp3428Async(I2cDevice i2CDevice, ModeEnum mode = ModeEnum.Continuous, ResolutionEnum resolution = ResolutionEnum.Bit12, GainEnum pgaGain = GainEnum.X1) : base(i2CDevice, mode, resolution, pgaGain)
        {
        }
    }
}
