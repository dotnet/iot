...
partial class Interop
{
    ...
    internal static readonly int UI_SET_EVBIT = _IOW(UINPUT_IOCTL_BASE, 100, typeof(int));
    internal static readonly int UI_SET_KEYBIT = _IOW(UINPUT_IOCTL_BASE, 101, typeof(int));
    internal static readonly int UI_SET_RELBIT = _IOW(UINPUT_IOCTL_BASE, 102, typeof(int));
    internal static readonly int UI_SET_ABSBIT = _IOW(UINPUT_IOCTL_BASE, 103, typeof(int));
    internal static readonly int UI_SET_MSCBIT = _IOW(UINPUT_IOCTL_BASE, 104, typeof(int));
    internal static readonly int UI_SET_LEDBIT = _IOW(UINPUT_IOCTL_BASE, 105, typeof(int));
    internal static readonly int UI_SET_SNDBIT = _IOW(UINPUT_IOCTL_BASE, 106, typeof(int));
    internal static readonly int UI_SET_FFBIT = _IOW(UINPUT_IOCTL_BASE, 107, typeof(int));

    internal static readonly int UI_DEV_SETUP = _IOW(UINPUT_IOCTL_BASE, 3, typeof(uinput_setup));
    internal static readonly int UI_ABS_SETUP = _IOW(UINPUT_IOCTL_BASE, 4, typeof(uinput_abs_setup));

    internal static readonly int UI_DEV_CREATE = _IO(UINPUT_IOCTL_BASE, 1);
    internal static readonly int UI_DEV_DESTROY = _IO(UINPUT_IOCTL_BASE, 2);
