...
namespace Iot.Device.Arduino
{
    public sealed class ArduinoMethodDeclaration
    {
        ...
        /// </summary>
        public ArduinoMethodDeclaration(int token, MethodBase methodBase, ArduinoMethodDeclaration? requestedBy, MethodFlags flags, int maxLocals, int maxStack, byte[]? ilBytes)
        {
            Index = -1;
