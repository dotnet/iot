...
namespace Iot.Device.Arduino
{
    internal enum CalendarId : ushort
    {
        ...
        GREGORIAN_ARABIC = 10, // 0x000A
        GREGORIAN_XLIT_ENGLISH = 11, // 0x000B
        GREGORIAN_XLIT_FRENCH = 12, // 0x000C
        JULIAN = 13, // 0x000D
        JAPANESELUNISOLAR = 14, // 0x000E
        CHINESELUNISOLAR = 15, // 0x000F
        SAKA = 16, // 0x0010
        LUNAR_ETO_CHN = 17, // 0x0011
        LUNAR_ETO_KOR = 18, // 0x0012
        LUNAR_ETO_ROKUYOU = 19, // 0x0013
        KOREANLUNISOLAR = 20, // 0x0014
        TAIWANLUNISOLAR = 21, // 0x0015
        PERSIAN = 22, // 0x0016
        LAST_CALENDAR = 23, // 0x0017
        UMALQURA = 23, // 0x0017
    }
    ...
    /// </remarks>
    [ArduinoReplacement("System.Globalization.CultureData")]
    internal partial class MiniCultureData
    {
        ...
        private string? _sSpecificCulture = "en_US"; // The culture name to be used in CultureInfo.CreateSpecificCulture(), en-US form if neutral, sort name if sort
        ...
        private CalendarId[]? _waCalendars;
        ...
        private static volatile Dictionary<string, MiniCultureData>? s_cachedRegions;
        private static volatile Dictionary<string, string>? s_regionNames;

        internal static MiniCultureData? GetCultureDataForRegion(string? cultureName, bool useUserOverride)
        {
            // First do a shortcut for Invariant
            return MiniCultureData.Invariant;
        }

        // Clear our internal caches
        internal static MiniCultureData[] GetCultures(CultureTypes types)
        {
            return new MiniCultureData[] { MiniCultureData.Invariant };
        }

        private static MiniCultureData CreateCultureWithInvariantData()
        {
            // Make a new culturedata
            MiniCultureData invariant = new MiniCultureData();
            ...
            invariant._iLanguage = 0;   // locale ID (0409) - NO sort information
        ...
        /// </summary>
        internal static MiniCultureData Invariant => s_Invariant ??= CreateCultureWithInvariantData();
        private static volatile MiniCultureData? s_Invariant;

        // Cache of cultures we've already looked up
        private static volatile Dictionary<string, MiniCultureData>? s_cachedCultures;
        ...
        internal static MiniCultureData GetCultureData(int culture, bool bUseUserOverride)
        {
            return Invariant;
        }
        ...
        /// </summary>
        internal string ThreeLetterWindowsLanguageName => _sAbbrevLang ??= "Invariant";
        ...
        /// </summary>
        internal string SCONSOLEFALLBACKNAME => _sConsoleFallbackName ??= "en-US";
