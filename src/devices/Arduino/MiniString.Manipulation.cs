...
// This code is from the runtime, disable some warnings
#pragma warning disable SA1503

namespace Iot.Device.Arduino
{
    internal partial class MiniString
    {
        private const int StackallocIntBufferSizeLimit = 128;

        [ArduinoImplementation(ArduinoImplementation.None, CompareByParameterNames = true)]
        private static void FillStringChecked(MiniString dest, int destPos, MiniString src)
        {
            ...
            MiniBuffer.Memmove(
                destination: ref MiniUnsafe.Add(ref dest._firstChar, destPos),
        ...
        [ArduinoImplementation(ArduinoImplementation.StringMiniStringConversion)]
        public static implicit operator MiniString(string value)
        {
            // The runtime knows that the two are equal (since it will replace one with the other)
