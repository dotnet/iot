    ...
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            using (Tm1637 tm1637 = new Tm1637(23, 24))
            {
                ...
                Thread.Sleep(100); //Some board need a delay for self initializing.
                ...
                for (int i = 0; i < 5; i++)
                {
                    tm1637.IsScreenOn = false; //turn off the screen
                    Thread.Sleep(200);
                    tm1637.SetScreen(3, true, false); //turn on the screen and set the brightness to 3
                    Thread.Sleep(200);
                    tm1637.SetScreen(7, true, false); //turn on the screen and set the brightness to 7
                    Thread.Sleep(200);
                }
