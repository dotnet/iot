...
namespace Samples
{
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                // When creating the instance without GpioController provided, a new instance of GpioController is created using logical pin numbering. The instance of GpioController is disposed with the instance of Tm16xx.
