...
namespace Iot.Device.Vcnl4040.Tests.Internal
{
    ...
    public class PsLowInterruptThresholdRegisterTest : RegisterTest
    {
        ...
        public void Read(byte thresholdHighByte, byte thresholdLowByte)
        {
            ...
            var reg = new PsLowInterruptThresholdRegister(testDevice);
            reg.Read();
        ...
        {
            PropertyWriteTest<PsLowInterruptThresholdRegister, ushort>(initialRegisterLowByte: 0x00,
                                                                       ...
                                                                       registerPropertyName: nameof(PsLowInterruptThresholdRegister.Level),
