...
namespace Iot.Device.Display
{
    ...
    public interface IFourteenSegmentDisplay
    {
        ...
        Segment14 this[int address] { get; set; }
        ...
        void Write(ReadOnlySpan<Segment14> digits, int startAddress = 0);
        ...
        /// <param name="startAddress">Address to start writing from</param>
        void Write(ReadOnlySpan<Font14> characters, int startAddress = 0);
    }
}
