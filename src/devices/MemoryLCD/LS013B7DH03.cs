...
namespace Iot.Device.MemoryLcd
{
    ...
    public class LS013B7DH03 : LSxxxB7DHxx
    {
        ...
        public LS013B7DH03(SpiDevice spi, GpioController gpio = null, bool shouldDispose = true, int scs = -1, int disp = -1, int extcomin = -1, PinNumberingScheme pinNumberingScheme = PinNumberingScheme.Logical)
