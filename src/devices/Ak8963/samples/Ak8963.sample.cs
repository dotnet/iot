...
namespace DemoAk8963
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Magnetometer calibration is taking couple of seconds, move your sensor in all possible directions! Make sure you don't have a magnet or phone close by.");
