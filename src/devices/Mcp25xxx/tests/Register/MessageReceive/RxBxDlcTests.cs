...
namespace Iot.Device.Mcp25xxx.Tests.Register.MessageReceive
{
    public class RxBxDlcTests
    {
        ...
        public void Get_RxBufferNumber_Address(RxBufferNumber rxBufferNumber, Address address)
        {
            ...
            Assert.Equal(address, new RxBxDlc(rxBufferNumber, 0b0000_0000, false).GetAddress());
        }

        [Theory]
        [InlineData(0b0000_0000, false, 0b0000_0000)]
        [InlineData(0b0000_1111, false, 0b0000_1111)]
        [InlineData(0b0000_0000, true, 0b0100_0000)]
