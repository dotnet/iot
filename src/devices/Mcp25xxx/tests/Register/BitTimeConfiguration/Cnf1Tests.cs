...
namespace Iot.Device.Mcp25xxx.Tests.Register.BitTimeConfiguration
{
    public class Cnf1Tests
    {
        ...
        [Theory]
        [InlineData(0b00_0000, Cnf1.SynchronizationJumpWidthLength.Tqx1, 0b0000_0000)]
        [InlineData(0b11_1111, Cnf1.SynchronizationJumpWidthLength.Tqx1, 0b0011_1111)]
        ...
        public void Invalid_Arguments()
        {
            Assert.Throws<ArgumentException>(() =>
             new Cnf1(0b100_0000, Cnf1.SynchronizationJumpWidthLength.Tqx1).ToByte());
        }
    }
}
