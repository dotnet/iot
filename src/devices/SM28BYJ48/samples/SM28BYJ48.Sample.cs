            ...
            using (SM28BYJ48 motor = new SM28BYJ48(bluePin, pinkPin, yellowPin, orangePin))
            {
                ...
                void movementCompleted()
                {
                    ...
                    if (clockwise)
                    {
                        ...
                        // So if you don't need to turn eternally you need to change it. For example, AddMovementCompletionHandler(motor.Stop) or AddMovementCompletionHandler(null)
