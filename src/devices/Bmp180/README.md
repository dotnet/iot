...
BMP180 is a device that read barometic pressure, altitude and temperature. I²C can be used to communicate with the device.
...
The following fritzing diagram illustrates one way to wire up the BMP180 with a Raspberry Pi using I²C.
