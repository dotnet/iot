...
internal static partial class Interop
{
    ...
    internal struct ErrorInfo
    {
        ...
        {
            get { return _rawErrno == -1 ? (_rawErrno = Sys.ConvertErrorPalToPlatform(_error)) : _rawErrno; }
        }
        ...
        {
            return $"ErrorNumber: {RawErrno} Error: {Error} ErrorMessage: { GetErrorMessage()}";
        }
    }
    ...
    internal partial class Sys
    {
        ...
        [DllImport(SystemNative, EntryPoint = "SystemNative_ConvertErrorPlatformToPal")]
        internal static extern Error ConvertErrorPlatformToPal(int platformErrno);

        [DllImport(SystemNative, EntryPoint = "SystemNative_ConvertErrorPalToPlatform")]
