...
namespace System.Device.Gpio
{
    ...
    {
        public static void ThrowIOException(ExceptionResource resource, int errorCode = -1, int pin = -1)
        {
            throw GetIOException(GetResourceString(resource, errorCode, pin));
        }

        public static void ThrowInvalidOperationException(ExceptionResource resource, int errorCode = -1, int pin = -1)
        {
            throw GetInvalidOperationException(GetResourceString(resource, errorCode, pin));
        }
        ...
        {
            return GetInvalidOperationException(GetResourceString(resource, -1, pin));
        }
