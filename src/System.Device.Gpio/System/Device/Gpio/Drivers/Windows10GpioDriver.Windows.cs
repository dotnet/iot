...
namespace System.Device.Gpio.Drivers
{
    public class Windows10GpioDriver : GpioDriver
    {
        ...
        private readonly Dictionary<int, Windows10GpioDriverPin> _openPins = new Dictionary<int, Windows10GpioDriverPin>();
        #endregion Fields
        ...
        {
            foreach (Windows10GpioDriverPin devicePin in _openPins.Values)
            {
                devicePin.Dispose();
            }
        ...
        {
            if (_openPins.TryGetValue(pinNumber, out Windows10GpioDriverPin pin))
            {
                pin.ClosePin();
        ...
        protected internal override void OpenPin(int pinNumber)
        {
            ...
            _openPins[pinNumber] = new Windows10GpioDriverPin(this, windowsPin);
        }
        ...
        private Windows10GpioDriverPin LookupOpenPin(int pinNumber) => _openPins[pinNumber];
