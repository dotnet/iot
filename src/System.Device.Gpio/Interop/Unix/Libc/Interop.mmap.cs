...
/// <summary>
/// The BCM GPIO registers expose the data/direction/interrupt/etc functionality of pins. Each register is 64 bits,
/// where each bit represents a logical register number.
/// 
