...
using System.Device.Ports.SerialPort.Tests;
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        internal static SerialPort? InitFirstSerialPort()
        {
        ...
        internal static SerialPort? InitSecondSerialPort(SerialPort com)
        {
            if (LocalMachineSerialInfo.NullModemPresent)
            {
        ...
        /// </summary>
        internal static void SetHighSpeed(SerialPort com1, SerialPort com2)
        {
            if (com1 != null)
            {
        ...
        /// </summary>
        internal static void WaitForWriteBufferToLoad(SerialPort com, int bufferLength)
        {
        ...
        /// </summary>
        internal static void WaitForExactWriteBufferLoad(SerialPort com, int bufferLength)
        {
        ...
        /// </summary>
        internal static void WaitForReadBufferToLoad(SerialPort? com, int bufferLength)
        {
            if (com == null)
            {
                Assert.NotNull(com);
