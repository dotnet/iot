    ...
    */
        ...
        public void EmptyNewLine()
        {
            using (SerialPort com = new SerialPort(TCSupport.LocalMachineSerialInfo.FirstAvailablePortName))
            {
                ...
                VerifyReadException(com, string.Empty, typeof(ArgumentException));
            }
        }
        ...
        private void PerformReadOnCom1FromCom2(SerialPort com1, SerialPort com2, string strToWrite, string newLine)
        {
            ...
            {
                Fail("Err_7797ajpba!!!: Expected to read \"{0}\"  actual read  \"{1}\"", string.Empty, expectedString, strBldrRead.ToString());
            }
