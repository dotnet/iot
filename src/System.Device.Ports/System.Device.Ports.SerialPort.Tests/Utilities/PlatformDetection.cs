...
namespace System
{
    ...
    {
        /*
        // Do not use the " { get; } = <expression> " pattern here.
        // Having all the initialization happen in the type initializer
        // means that one exception anywhere means all tests using
        // PlatformDetection fail. If you feel a value is worth latching,
