    ...
    internal static partial class Number
    {
        ...
        internal unsafe ref struct BigInteger
        {
            ...
            public static void DivRem(ref BigInteger lhs, ref BigInteger rhs, out BigInteger quo, out BigInteger rem)
            {
                ...
                {
                    uint quotient = Number.DivRem(lhs._blocks[0], rhs._blocks[0], out uint remainder);
                ...
                if (rhsLength == 1)
                {
                    ...
                    for (int i = quoLength - 1; i >= 0; i--)
                    {
                        ...
                        ulong digit = Number.DivRem(value, rhsValue, out carry);
            ...
            public static void Multiply(ref BigInteger lhs, ref BigInteger rhs, out BigInteger result)
            {
                ...
                ZeroMemory((byte*)result.GetBlocksPointer(), (uint)maxResultLength * sizeof(uint));
            ...
            public static void Pow2(uint exponent, out BigInteger result)
            {
                ...
                if (blocksToShift > 0)
                {
                    ZeroMemory((byte*)result.GetBlocksPointer(), blocksToShift * sizeof(uint));
                }
            ...
            public static void SetValue(out BigInteger result, ref BigInteger value)
            {
                ...
                Memcpy((byte*)result.GetBlocksPointer(), (byte*)value.GetBlocksPointer(), rhsLength * sizeof(uint));
            }
            ...
            public void ShiftLeft(uint shift)
            {
                ...
                if (remainingBitsToShift == 0)
                {
                    ...
                    ZeroMemory((byte*)GetBlocksPointer(), blocksToShift * sizeof(uint));
                }
                else
                {
