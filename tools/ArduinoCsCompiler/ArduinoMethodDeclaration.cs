...
namespace ArduinoCsCompiler
{
    internal sealed class ArduinoMethodDeclaration
    {
        ...
        /// </summary>
        public ArduinoMethodDeclaration(int token, EquatableMethod methodBase, ArduinoMethodDeclaration? requestedBy, MethodFlags flags, int maxLocals, int maxStack, IlCode code)
        {
            Index = -1;
